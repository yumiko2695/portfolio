      ...
      <div className="project1">
        ...
        <div className="project-footer">
          <div className="img-container">
            ...
            <img type="image/svg+xml" src="https://storage.cloud.google.com/yumi-s-house-images/25231.svg" width="30px" height="30px"/>
            </a>
          </div>
          <div className="img-container">
            <a href=""  target="_blank">
            <img type="image/png" src="https://storage.cloud.google.com/yumi-s-house-images/Screen-Shot-2015-06-15-at-19.22.42.png" width="30px" height="30px"/>
            </a>
          </div>
        </div>
      </div>
